package net.azarquiel.mycuisine.view.picker
...
class PickerPacoPul(var activity: Activity ) {
    ...
    private fun checkPermiss() {
        if (    ContextCompat.checkSelfPermission(activity, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED
            ...
            ActivityCompat.requestPermissions(activity,
                    ...
                    NewRecipeActivity.REQUEST_PERMISSION
            )
        }
    }
    ...
    private fun photoFromGallery() {
        ...
        activity.startActivityForResult(galleryIntent, NewRecipeActivity.REQUEST_GALLERY)
    ...
    private fun photoFromCamera() {
        ...
        if (intent.resolveActivity(activity.packageManager) != null) {
            ...
            photoFile?.let {
                ...
                activity.startActivityForResult(intent, NewRecipeActivity.REQUEST_CAMERA)
            }
        }
    ...
    fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>, grantResults: IntArray) {
        if (requestCode == NewRecipeActivity.REQUEST_PERMISSION && grantResults.isNotEmpty()) {
    ...
    fun onActivityResult(requestCode:Int, resultCode:Int, data: Intent?) {
        if (resultCode == Activity.RESULT_OK) {
            when (requestCode) {
                NewRecipeActivity.REQUEST_GALLERY -> {
                    data?.let {
                ...
                NewRecipeActivity.REQUEST_CAMERA -> {
